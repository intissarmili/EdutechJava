...
public class affichierCertificationControllerB {

    @FXML private TableView<Certification> certificationTable;
    @FXML private TableColumn<Certification, Integer> idCol, prixPieceCol, noteCol;
    @FXML private TableColumn<Certification, String> nomCol, descriptionCol;
    ...
    private void setupTable() {
        ...
        actionsCol.setCellFactory(param -> new TableCell<>() {
            ...
            {
                editBtn.setStyle("-fx-background-color: #1cacd2; -fx-text-fill: white; -fx-font-weight: bold;");
    ...
    private void setupButtons() {
        ...
        // Style des boutons
        String buttonStyle = "-fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 8 20;";
        addBtn.setStyle("-fx-background-color: #16ac63; " + buttonStyle);
        deleteBtn.setStyle("-fx-background-color: #e74c3c; " + buttonStyle);
        backBtn.setStyle("-fx-background-color: #4154f1; " + buttonStyle);
    }
    ...
    // ... (autres méthodes handleAddCertification, handleEditCertification, etc. restent inchangées)
}