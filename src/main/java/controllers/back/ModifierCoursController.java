...
public class ModifierCoursController {
    ...
    @FXML private TextArea contenuM; // Changer pour TextArea
    ...
    private void populateFields() {
        if (coursToEdit != null) {
            ...
            contenuM.setText(coursToEdit.getContenu()); // Remplir le TextArea
    ...
    private void ButtonConfirmerM() {
        if (validateFields()) {
            ...
            coursToEdit.setContenu(contenuM.getText()); // Récupérer le texte du TextArea
