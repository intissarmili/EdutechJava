...
public class affichierCoursBackController {
    ...
    private void configureTableColumns() {
        ...
        // Colonne Actions avec icône crayon
    ...
    private void openModificationWindow(Cours cours) {
        try {
            ...
            loadCoursData(); // Rafraîchir après modification
        } catch (IOException e) {
    ...
    @FXML
    void BouttonAddCours(ActionEvent event) {
        try {
    ...
    @FXML
    void BouttonSupCours(ActionEvent event) {
