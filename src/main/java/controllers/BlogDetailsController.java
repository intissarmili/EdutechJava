...
public class BlogDetailsController {
    ...
    public void playQuiz(int certificationId) {
        try {
            // Charger la vue du quiz
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/path/to/QuizView.fxml"));
            ...
            // Initialiser le quiz
            quizController.initializeQuiz(certificationId);

            // Afficher la vue (par exemple dans une nouvelle fenêtre ou en remplacement du contenu actuel)
            ...
            alert.setContentText("Une erreur est survenue lors du chargement du quiz.");
            alert.showAndWait();
        }
    }
